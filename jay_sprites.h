...
PROGMEM const uint8_t PRINTABLE_CHARS [] = {
    ...
    // Lowercase a-z (and unused {|}~) removed to save flash: the
    // renderer's c-=32 mapping only ever indexes space..'`' — all UI
    // text is uppercase/digits/symbols.
};
...
PROGMEM const uint8_t PRINTABLE_CHARS_LARGE [] = {
    ...
    0x80, 0x80, 0x80, 0x80, 0x80, 0x00, 0x01, 0x02, 0x00, 0x00, //_`
    // Lowercase a-z (and unused {|}~) removed to save flash
    // (see PRINTABLE_CHARS): only space..'`' is ever rendered.
};